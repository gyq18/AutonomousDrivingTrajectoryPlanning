...
def reeds_shepp_path_planning(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=0.2):
    ...
    return b_path.x, b_path.y, b_path.yaw, b_path.L
...
#     start_x = 0.0  # [m]
#     start_y = 0.0  # [m]
#     start_yaw = np.deg2rad(45)  # [rad]

#     end_x = 2.0  # [m]
#     end_y = 2.0  # [m]
#     end_yaw = np.deg2rad(45)  # [rad]

#     curvature = 0.3
#     step_size = 0.05

#     xs, ys, yaws, lengths = reeds_shepp_path_planning(start_x, start_y,
#                                                              start_yaw, end_x,
#                                                              end_y, end_yaw,
#                                                              curvature,
#                                                              step_size)                                                    
