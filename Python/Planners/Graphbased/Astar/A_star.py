...
def get_motion_model():
    # dx, dy, cost
    step_ = astar_.simulation_step/astar_.resolution_x
...
def PlanAStarPath():
    ...
    while 1:
        ...
        if math.fabs(current.x - goal_node.x < astar_.simulation_step) and math.fabs(current.y - goal_node.y) < astar_.simulation_step:
            completeness_flag = 1
