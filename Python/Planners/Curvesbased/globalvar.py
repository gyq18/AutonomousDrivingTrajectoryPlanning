...
class planning_scale_Set:
    def __init__(self) -> None:
        ...
        self.xmax = 60
        self.ymin = 0
        self.ymax = 60  # space is a rectange, [lx,ux],[ly,uy]
...
resolution_y = 0.1
global num_nodes_x
num_nodes_x = math.ceil(planning_scale_.x_scale/resolution_x)+1
global num_nodes_y
num_nodes_y = math.ceil(planning_scale_.y_scale/resolution_y)+1
global costmap_
