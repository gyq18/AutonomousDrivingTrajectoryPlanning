...
std::vector<math::Vec2d> CreateVehiclePolygon(double x, double y, double theta);
double triArea(math::Vec2d p1, math::Vec2d p2, math::Vec2d p3);//  the area of triangle formed by the three points
bool checkObj_point(math::Vec2d p, std::vector<math::Vec2d> obj);// check point wheather in obstacle (based on area )
bool PtInPolygon(math::Vec2d p, std::vector<math::Vec2d>& ptPolygon);// check point wheather in Polygon (based on ray method )
bool checkObj_linev(math::Vec2d p1, math::Vec2d p2, std::vector<math::Vec2d> obj);
bool PtInPolygon(double x, double y, std::vector<math::Vec2d>& ptPolygon);
double rand01();
std::vector < std::vector<math::Vec2d> > GenerateStaticObstacles_unstructured();