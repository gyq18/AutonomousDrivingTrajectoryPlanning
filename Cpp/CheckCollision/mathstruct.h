...
struct Vehicle_geometrics_
{
    ...
    {
        this->vehicle_wheelbase = wheelbase;
        this->vehicle_front_hang = front_hang;
        this->vehicle_rear_hang = rear_hang;
        this->vehicle_width = width;
        this->vehicle_length = this->vehicle_wheelbase + this->vehicle_front_hang + this->vehicle_rear_hang;
