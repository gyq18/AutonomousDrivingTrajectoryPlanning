%  This is the template for testing the Informd RRT Star planner. The randomly generated obstacles are
...
[x, y, theta, path_length, ~] = PlanInformedRRTStarPath();
...
%% resample path with equal distanceâ€”â?”make path have enough nodes
