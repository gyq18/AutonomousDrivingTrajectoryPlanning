...
vehicle_TPBV_.xtf=54; vehicle_TPBV_.ytf=54;vehicle_TPBV_.thetatf=0;vehicle_TPBV_.vtf=0;vehicle_TPBV_.phitf=0;vehicle_TPBV_.a=0;vehicle_TPBV_.omegatf=0;
...
%     t_total = 0;
%     for i = 1:3
%         [x, y, theta, path_length, completeness_flag, t2] = SimpleLatticePlan(1, "look_up_table_153244.txt", "insert_points.txt"); %including: CreateDilatedCostmap(),ResampleConfig(x, y, theta);
%         t_total = t_total + t2;
%     end
%     t_total = t_total / 3;
%     disp(t_total)
...
[x, y, theta, path_length, completeness_flag, time] = ImprovedLatticePlan(1, "look_up_table_121628.txt", "insert_points.txt"); %including: CreateDilatedCostmap(),ResampleConfig(x, y, theta);
